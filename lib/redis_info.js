...
(function() {
  var CMDS, CMD_KEYS, INFO, INTERVAL_MULTIPLE, INTERVAL_TIME, LOG_PATH, REDIS, SLOWLOG, async, child_process, dateFormat, debuglog, fs, init, mailer, mkdirp, regExp, start, timeout, _, _validateInfo;
