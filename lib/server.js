...
(function() {
  ...
  p.version(pkg.version).option('-e, --environment [type]', 'runtime environment of [development, production, testing]', 'development').option('-l, --loger [value]', 'runtime log file dir', "" + (path.join(os.tmpdir(), 'redis_info'))).parse(process.argv);
